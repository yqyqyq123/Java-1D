...
public class MarkerDemoActivity extends AppCompatActivity implements
    ...
    DatabaseReference locationRef = db.getReference("java1dcarpark").child("currentLocation");
    ...
    @Override
    public void onMarkerDragEnd(Marker marker) { mTopText.setText("onMarkerDragEnd");}
    ...
    public void saveData(View view) {
        ...
        locationRef.setValue(currentLocData).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
                Log.d("currentLocData", "Current location has been saved!");
                Toast.makeText(MarkerDemoActivity.this,"Location is saved",Toast.LENGTH_SHORT).show();
