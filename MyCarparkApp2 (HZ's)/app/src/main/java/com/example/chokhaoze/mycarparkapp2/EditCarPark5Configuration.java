...
public class EditCarPark5Configuration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.edit_car_park_5_configuration);
        ...
        buttonSlot1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EditCarPark5Configuration.this,"Slot 1 Selected", Toast.LENGTH_SHORT).show();
                count4 += 1;
        ...
        buttonSlot2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EditCarPark5Configuration.this,"Slot 2 Selected", Toast.LENGTH_SHORT).show();
                count4 += 1;
                textViewCount.setText("Number of Vacancies = " + String.valueOf(count4) + "/20");
            }
        });
        ...
        buttonSlot3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EditCarPark5Configuration.this,"Slot 3 Selected", Toast.LENGTH_SHORT).show();
                count4 += 1;
                textViewCount.setText("Number of Vacancies = " + String.valueOf(count4) + "/20");
            }
        });
        ...
        buttonSlot4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EditCarPark5Configuration.this,"Slot 4 Selected", Toast.LENGTH_SHORT).show();
                count4 += 1;
                textViewCount.setText("Number of Vacancies = " + String.valueOf(count4) + "/20");
            }
        });
        ...
        buttonSlot5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EditCarPark5Configuration.this,"Slot 5 Selected", Toast.LENGTH_SHORT).show();
                count4 += 1;
                textViewCount.setText("Number of Vacancies = " + String.valueOf(count4) + "/20");
            }
        });
        ...
        buttonSlot6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EditCarPark5Configuration.this,"Slot 6 Selected", Toast.LENGTH_SHORT).show();
                count4 += 1;
                textViewCount.setText("Number of Vacancies = " + String.valueOf(count4) + "/20");
            }
        });
        ...
        buttonSlot7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EditCarPark5Configuration.this,"Slot 7 Selected", Toast.LENGTH_SHORT).show();
                count4 += 1;
                textViewCount.setText("Number of Vacancies = " + String.valueOf(count4) + "/20");
            }
        });
        ...
        buttonSlot8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EditCarPark5Configuration.this,"Slot 8 Selected", Toast.LENGTH_SHORT).show();
                count4 += 1;
                textViewCount.setText("Number of Vacancies = " + String.valueOf(count4) + "/20");
            }
        });
        ...
        buttonSlot9.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EditCarPark5Configuration.this,"Slot 9 Selected", Toast.LENGTH_SHORT).show();
                count4 += 1;
                textViewCount.setText("Number of Vacancies = " + String.valueOf(count4) + "/20");
            }
        });
        ...
        buttonSlot10.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EditCarPark5Configuration.this,"Slot 10 Selected", Toast.LENGTH_SHORT).show();
                count4 += 1;
                textViewCount.setText("Number of Vacancies = " + String.valueOf(count4) + "/20");
            }
        });
        ...
        buttonSlot11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EditCarPark5Configuration.this,"Slot 11 Selected", Toast.LENGTH_SHORT).show();
                count4 += 1;
                textViewCount.setText("Number of Vacancies = " + String.valueOf(count4) + "/20");
            }
        ...
        buttonSlot12.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EditCarPark5Configuration.this,"Slot 12 Selected", Toast.LENGTH_SHORT).show();
                count4 += 1;
                textViewCount.setText("Number of Vacancies = " + String.valueOf(count4) + "/20");
            }
        });
        ...
        buttonSlot13.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EditCarPark5Configuration.this,"Slot 13 Selected", Toast.LENGTH_SHORT).show();
                count4 += 1;
                textViewCount.setText("Number of Vacancies = " + String.valueOf(count4) + "/20");
            }
        });
        ...
        buttonSlot14.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EditCarPark5Configuration.this,"Slot 14 Selected", Toast.LENGTH_SHORT).show();
                count4 += 1;
                textViewCount.setText("Number of Vacancies = " + String.valueOf(count4) + "/20");
            }
        });
        ...
        buttonSlot15.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EditCarPark5Configuration.this,"Slot 15 Selected", Toast.LENGTH_SHORT).show();
                count4 += 1;
                textViewCount.setText("Number of Vacancies = " + String.valueOf(count4) + "/20");
            }
        });
        ...
        buttonSlot16.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EditCarPark5Configuration.this,"Slot 16 Selected", Toast.LENGTH_SHORT).show();
                count4 += 1;
                textViewCount.setText("Number of Vacancies = " + String.valueOf(count4) + "/20");
            }
        });
        ...
        buttonSlot17.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EditCarPark5Configuration.this,"Slot 17 Selected", Toast.LENGTH_SHORT).show();
                count4 += 1;
                textViewCount.setText("Number of Vacancies = " + String.valueOf(count4) + "/20");
            }
        });
        ...
        buttonSlot18.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EditCarPark5Configuration.this,"Slot 18 Selected", Toast.LENGTH_SHORT).show();
                count4 += 1;
                textViewCount.setText("Number of Vacancies = " + String.valueOf(count4) + "/20");
            }
        });
        ...
        buttonSlot19.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EditCarPark5Configuration.this,"Slot 19 Selected", Toast.LENGTH_SHORT).show();
                count4 += 1;
                textViewCount.setText("Number of Vacancies = " + String.valueOf(count4) + "/20");
            }
        });
        ...
        buttonSlot20.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EditCarPark5Configuration.this,"Slot 20 Selected", Toast.LENGTH_SHORT).show();
                count4 += 1;
                textViewCount.setText("Number of Vacancies = " + String.valueOf(count4) + "/20");
            }
        });
        ...
        buttonSaveConfig.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EditCarPark5Configuration.this,"Saving...", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(EditCarPark5Configuration.this , SetCarParkConfiguration.class);//links MainActivity to SubActivity
        ...
        buttonResetConfig.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(EditCarPark5Configuration.this,"Reseting...", Toast.LENGTH_SHORT).show();
