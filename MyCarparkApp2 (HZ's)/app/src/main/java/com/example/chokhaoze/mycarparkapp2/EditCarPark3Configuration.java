    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSlot1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                count3 += 1;
                textViewCount.setText("Number of Vacancies = " + String.valueOf(count3) + "/20");
            }
        ...
        buttonSlot11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EditCarPark3Configuration.this,"Slot 11 Selected", Toast.LENGTH_SHORT).show();
                count3 += 1;
                textViewCount.setText("Number of Vacancies = " + String.valueOf(count3) + "/20");
            }
        ...
        buttonSlot12.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EditCarPark3Configuration.this,"Slot 12 Selected", Toast.LENGTH_SHORT).show();
                count3 += 1;
                textViewCount.setText("Number of Vacancies = " + String.valueOf(count3) + "/20");
            }
        });
        ...
        buttonSlot13.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EditCarPark3Configuration.this,"Slot 13 Selected", Toast.LENGTH_SHORT).show();
                count3 += 1;
                textViewCount.setText("Number of Vacancies = " + String.valueOf(count3) + "/20");
            }
        });
        ...
        buttonSlot14.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EditCarPark3Configuration.this,"Slot 14 Selected", Toast.LENGTH_SHORT).show();
                count3 += 1;
                textViewCount.setText("Number of Vacancies = " + String.valueOf(count3) + "/20");
            }
        });
        ...
        buttonSlot15.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EditCarPark3Configuration.this,"Slot 15 Selected", Toast.LENGTH_SHORT).show();
                count3 += 1;
                textViewCount.setText("Number of Vacancies = " + String.valueOf(count3) + "/20");
            }
        });
        ...
        buttonSlot16.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EditCarPark3Configuration.this,"Slot 16 Selected", Toast.LENGTH_SHORT).show();
                count3 += 1;
                textViewCount.setText("Number of Vacancies = " + String.valueOf(count3) + "/20");
            }
        });
        ...
        buttonSlot17.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EditCarPark3Configuration.this,"Slot 17 Selected", Toast.LENGTH_SHORT).show();
                count3 += 1;
                textViewCount.setText("Number of Vacancies = " + String.valueOf(count3) + "/20");
            }
        });
        ...
        buttonSlot18.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EditCarPark3Configuration.this,"Slot 18 Selected", Toast.LENGTH_SHORT).show();
                count3 += 1;
                textViewCount.setText("Number of Vacancies = " + String.valueOf(count3) + "/20");
            }
        });
        ...
        buttonSlot19.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EditCarPark3Configuration.this,"Slot 19 Selected", Toast.LENGTH_SHORT).show();
                count3 += 1;
                textViewCount.setText("Number of Vacancies = " + String.valueOf(count3) + "/20");
            }
        });
        ...
        buttonSlot20.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EditCarPark3Configuration.this,"Slot 20 Selected", Toast.LENGTH_SHORT).show();
                count3 += 1;
                textViewCount.setText("Number of Vacancies = " + String.valueOf(count3) + "/20");
            }
        });
        ...
        buttonSaveConfig.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EditCarPark3Configuration.this,"Saving...", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(EditCarPark3Configuration.this , SetCarParkConfiguration.class);//links MainActivity to SubActivity
